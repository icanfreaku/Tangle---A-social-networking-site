 ...
 * @author sumitha
 */
public class submit_post extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        response.sendRedirect("myhood.jsp");
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet submit_post</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet submit_post at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
        }
